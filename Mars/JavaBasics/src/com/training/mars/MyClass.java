...
local - available only inside a block
instance- available for that object
instance - shared across objects and is accessed without instance
...
varaible name:starts with char or (_ or $), camelCase,
